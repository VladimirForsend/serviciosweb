    ...
    <main class="background-tercero">
        ...
        <section id="SeccionPrincipal" class="container py-3">
            <div class="row">
                ...
                <?php }; ?>
                <div id="Desplegables" class="col-12 col-md-6 col-lg-5 d-flex flex-column">
                    <!-- desplegables -->
                    ...
                    <?php $desplegable2 = get_field('nombre_desplegable_dos'); if(!empty($desplegable2)) {?>
                        <button class="boton-desplegable" data-toggle="collapse" data-target="#desplegable2" aria-expanded="false" aria-controls="desplegable2">
                    ...
                    <?php $desplegable3 = get_field('nombre_desplegable_tres'); if(!empty($desplegable3)) {?>
                        <button class="boton-desplegable" data-toggle="collapse" data-target="#desplegable3" aria-expanded="false" aria-controls="desplegable3">
        ...
        <section id="SeccionSecundaria" class="container py-5">
            <div class="row flex-row-reverse">
                <div class="col-12 col-md-6 col-lg-7">
                    ...
                    ?>
                    <div class="container informacion-socios">
                        <?php $correo = get_field('correo'); if(!empty($correo)) {?>
                            <p><span class="bold">CORREO: </span><?php the_field('correo'); ?></p>    
                        <?php }; ?>
                        <?php $telefono = get_field('telefono'); if(!empty($telefono)) {?>
                            <p><span class="bold">TELÉFONO: </span><?php the_field('telefono'); ?></p>    
                        <?php }; ?>
                        <?php $direccion = get_field('direccion'); if(!empty($direccion)) {?>
                            <p><span class="bold">DIRECCIÓN: </span><?php the_field('direccion'); ?></p>    
                        <?php }; ?>
                        <?php $web = get_field('web'); if(!empty($web)) {?>
                            <p><span class="bold">SITIO WEB: </span><a class="web" href="<?php the_field('web',false,false);?>" target="_blank" title="visitar sitio web"><?php the_field('web'); ?></a></p>    
                        <?php }; ?>
                        <div class="d-flex socios-rrss">
                            <?php $facebook = get_field('facebook'); if(!empty($facebook)) {?>
                                <a class="d-inline-block mr-5" href="<?php the_field('facebook',false,false); ?>" target="_blank" title="visitar facebook"><i class="fab fa-facebook-f"></i></a>    
                            <?php }; ?>
                            <?php $instagram = get_field('instagram'); if(!empty($instagram)) {?>
                                <a class="d-inline-block mr-5" href="<?php the_field('instagram',false,false); ?>" target="_blank" title="visitar instagram"><i class="fab fa-instagram"></i></a>    
                            <?php }; ?>
                            <?php $whatsapp = get_field('whatsapp'); if(!empty($whatsapp)) {?>
                                <a class="d-inline-block" href="https://api.whatsapp.com/send?phone=<?php the_field('whatsapp',false,false); ?>&text=Hola%20Quisiera%20saber%20más." target="_blank" title="contactar por whatsapp"><i class="fab fa-whatsapp"></i></a>    
                            <?php }; ?>
                        </div>
                    </div>
                </div>
