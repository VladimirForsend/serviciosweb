<style>
	<?php include get_template_directory() . '/assets/modulos/modulo-testimonios2/testimonios2.css'; ?>
</style>
<div id="comercio-beneficios" class="container mt-5">
	<h3 class="service-title text-center">Testimonios</h3>
	...
	<div class="row">
		...
		if (have_posts()) : while ($wp_query->have_posts()) : $wp_query->the_post(); ?>
			...
			<div id="beneficios-seniors1" class="col-4">
				<div class="row mb-3">
			...
			<div id="beneficios-seniors2" class="col-4">
				<div class="row mb-3">
					<div class="beneficios-icon col-3">
			...
			<div id="beneficios-seniors3" class="col-4">
				<div class="row mb-3">
					<div class="beneficios-icon col-3">
						<?php $imagen6 = get_field('icon_1'); 
							if( !empty( $imagen6 ) ): ?>
